...
var file_game_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x52, 0x07, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x2a, 0x3f,
...
var file_game_proto_goTypes = []interface{}{
	...
	(*Players)(nil),    // 7: proto.Players
	nil,                // 8: proto.GameStats.RoundStatsEntry
}
var file_game_proto_depIdxs = []int32{
	1, // 0: proto.GameConfig.difficulty:type_name -> proto.Difficulty
	2, // 1: proto.GameConfig.fileSize:type_name -> proto.FileSize
	8, // 2: proto.GameStats.roundStats:type_name -> proto.GameStats.RoundStatsEntry
	5, // 3: proto.Player.stats:type_name -> proto.GameStats
	6, // 4: proto.Players.players:type_name -> proto.Player
	4, // 5: proto.GameStats.RoundStatsEntry.value:type_name -> proto.RoundStats
